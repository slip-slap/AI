...
skipgram_model_training(X,Y_one_hot,vocab_size,emb_size=5,learning_rate=0.08,epochs=5000,batch_size=2,parameters=None,print_cost=True,plot_cost=True)
